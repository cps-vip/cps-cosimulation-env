# Credit to dnp3-python for creating this demo of this python package we will use to simulate DNP3
# This is just a generic example that creates randomly variable junk data at set intervals. This will be modified to fit our purposes of communicating data

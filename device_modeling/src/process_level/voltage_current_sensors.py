...
if __name__ == "__main__":
    vcs = VoltageCurrentSensor(0, 0)
    #broker = create_broker()
    # fed = create_federate()

    #################################  Registering  federate from json  ########################################

    fed = h.helicsCreateValueFederateFromConfig("voltage_current_sensors_config.json")
    h.helicsFederateRegisterInterfaces(fed, "voltage_current_sensors_config.json")

# python3 -m unittest -v tests/unit_tests/circuitbreaker_unit_test.py
...
class TestCircuitBreaker(unittest.TestCase):
    ...
    def test_close_circuit_breaker(self):
        ...
        self.assertTrue(self.circuit_breaker.is_closed_status())
    ...
    def test_open_circuit_breaker(self):
        ...
        self.assertFalse(self.circuit_breaker.is_closed_status())
    ...
    def test_trip_circuit_breaker(self):
        ...
        self.assertTrue(self.circuit_breaker.trip_cmd)

    def test_get_max_current(self):
        max_current = self.circuit_breaker.get_max_current()
        self.assertEqual(max_current, 100.0)

    def test_get_logical_node_name(self):
        logical_node_name = self.circuit_breaker.get_node_name()
    ...
    def test_default_state(self):
        ...
        self.assertTrue(self.circuit_breaker.is_closed_status())
        self.assertEqual(self.circuit_breaker.position, 0)
        self.assertFalse(self.circuit_breaker.trip_cmd)
